...
<body class="overflow-hidden">
    ...
    <div class="w-full lg:mt-12 min-h-[550px] grid  justify-center relative z-10">
        <form id="login-form" class="bg-background rounded-lg pt-6 w-full flex flex-col items-center lg:gap-6 lg:max-w-[420px] lg:min-w-[414px]" action="login" method="post">
            <?= csrf_field() ?>
            ...
            <div class="flex flex-col gap-[30px]">
                <input class="w-full outline outline-1 pl-2 lg:min-w-[255px] lg:max-w-[260px] lg:min-h-[45px] lg:max-h-[50px]" type="text" name="email" id="email" placeholder="Email">
                <div>
                    <input class="w-full outline block outline-1 pl-2 lg:min-w-[255px] lg:max-w-[260px] lg:min-h-[45px] lg:max-h-[50px]" type="password" name="password" id="password" placeholder="Password">
