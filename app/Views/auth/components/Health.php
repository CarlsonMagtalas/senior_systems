    ...
    <div class="flex flex-col gap-4">
        <div class="flex justify-between">
            ...
            <div>
                ...
                <select class="bg-white lg:pl-1 lg:min-w-[260px] lg:max-w-[270px] lg:min-h-[23px] lg:max-h-[25px] outline outline-1" name="blood_id" id="" required>
            ...
            <div>
                ...
                <select class="bg-white lg:pl-1 lg:min-w-[260px] lg:max-w-[270px] lg:min-h-[23px] lg:max-h-[25px] outline outline-1" name="physical_id" id="">
