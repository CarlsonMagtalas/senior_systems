<div>
    <div class="flex justify-between">
        <div>
            ...
            <select class="bg-white lg:pl-1 lg:min-w-[130px] lg:max-w-[135px] lg:min-h-[23px] lg:max-h-[25px] outline outline-1" name="province_id" id="" required>
        ...
        <div>
            ...
            <select class="bg-white lg:pl-1 lg:min-w-[130px] lg:max-w-[135px] lg:min-h-[23px] lg:max-h-[25px] outline outline-1" name="municipality_id" id="" required>
        ...
        <div>
            ...
            <select class="bg-white lg:pl-1 lg:min-w-[130px] lg:max-w-[135px] lg:min-h-[23px] lg:max-h-[25px] outline outline-1" name="barangay_id" id="" required>
        ...
        <div>
            ...
            <select class="bg-white lg:pl-1 lg:min-w-[130px] lg:max-w-[135px] lg:min-h-[23px] lg:max-h-[25px] outline outline-1" name="purok_id" id="" required>
                <option value="" hidden>Purok</option>
